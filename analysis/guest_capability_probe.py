...
def run_suite(tier: str, uid: str, token: str, sample_other_uid: str = "1") -> List[Probe]:
    ...
    cases = [
        ...
        ("自己资料Me", "getUserAttributesMe1", {"userId": uid or "0", "phonebrand": "Android", "pushregid": "p", "version_code": "148"}),
        ("关注列表", "getFollowList", {"id": uid or "0"}),
        ("粉丝列表", "getFansUser", {"id": uid or "0", "pageIndex": "1"}),
        ("发帖相关-filter", "getFilterWords", {}),
        ("敏感词", "getIllegalWord", {}),
        ("聊天审查配置", "getChatCensorship", {}),
        ("在线心跳", "UpdateOnline0", {"id": uid or "0", "sign": md5_hex((uid or "0") + "socialchat" + (uid or "0")), "version_code": "148"}),
